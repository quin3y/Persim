...
/*SF_DATA;ver:0.25;sub:START;pass:START;ps:flbk:Specular,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,hqsc:True,hqlp:False,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.1280277,fgcg:0.1953466,fgcb:0.2352941,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0;n:type:ShaderForge.SFN_Final,id:1,x:32719,y:32712|diff-12-OUT,spec-23-OUT,gloss-24-OUT,transm-37-RGB,amspl-92-OUT;n:type:ShaderForge.SFN_Color,id:8,x:34165,y:32509,ptlb:Color,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:10,x:33619,y:32361|A-8-RGB,B-50-OUT;n:type:ShaderForge.SFN_Tex2d,id:11,x:33063,y:32231,ptlb:LightMap,ntxv:0,isnm:False|UVIN-16-UVOUT,MIP-16-U;n:type:ShaderForge.SFN_Multiply,id:12,x:32835,y:32329|A-13-OUT,B-58-OUT;n:type:ShaderForge.SFN_Multiply,id:13,x:32939,y:32068|A-11-RGB,B-15-OUT;n:type:ShaderForge.SFN_Slider,id:15,x:33175,y:32091,ptlb:LightBrightness,min:1,cur:3,max:5;n:type:ShaderForge.SFN_TexCoord,id:16,x:33293,y:32161,uv:1;n:type:ShaderForge.SFN_ValueProperty,id:23,x:33026,y:32814,ptlb:Specular,v1:0.5;n:type:ShaderForge.SFN_ValueProperty,id:24,x:33007,y:32918,ptlb:Gloss,v1:0.3;n:type:ShaderForge.SFN_Color,id:37,x:33021,y:33180,ptlb:TransmissionColor,c1:0.625,c2:0.5489351,c3:0.3492647,c4:1;n:type:ShaderForge.SFN_Fresnel,id:50,x:34162,y:32236;n:type:ShaderForge.SFN_Lerp,id:58,x:33368,y:32410|A-8-RGB,B-10-OUT,T-50-OUT;n:type:ShaderForge.SFN_Cubemap,id:90,x:33300,y:33005,ptlb:Cube;n:type:ShaderForge.SFN_ValueProperty,id:91,x:33308,y:32863,ptlb:CubeIntensity,v1:0.3;n:type:ShaderForge.SFN_Multiply,id:92,x:33119,y:32974|A-91-OUT,B-90-RGB;proporder:8-37-23-24-90-91-11-15;pass:END;sub:END;*/

Shader "Props/Color_Spc_Ref" {
    Properties {
        ...
        _CubeIntensity ("CubeIntensity", Float ) = 0.3
...
////// Specular:
                ...
                float3 specularAmb = (_CubeIntensity*texCUBE(_Cube,viewReflectDirection).rgb) * specularColor;
