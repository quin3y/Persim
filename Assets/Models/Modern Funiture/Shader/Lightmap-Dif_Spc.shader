...
////// Specular:
                ...
                finalColor += diffuseLight * ((tex2Dlod(_LightMap,float4(TRANSFORM_TEX(node_16.rg, _LightMap),0.0,node_16.r)).rgb*_LightBrightness)*(_Color.rgb*tex2D(_MainTex,TRANSFORM_TEX(node_48.rg, _MainTex)).rgb));
                finalColor += specular;
/// Final Color:
...
////// Specular:
                ...
                finalColor += diffuseLight * ((tex2Dlod(_LightMap,float4(TRANSFORM_TEX(node_16.rg, _LightMap),0.0,node_16.r)).rgb*_LightBrightness)*(_Color.rgb*tex2D(_MainTex,TRANSFORM_TEX(node_49.rg, _MainTex)).rgb));
                finalColor += specular;
/// Final Color:
