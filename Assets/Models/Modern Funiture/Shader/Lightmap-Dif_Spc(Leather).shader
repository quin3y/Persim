...
/*SF_DATA;ver:0.25;sub:START;pass:START;ps:flbk:Diffuse,lico:1,lgpr:1,nrmq:1,limd:3,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True,hqsc:True,hqlp:False,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0;n:type:ShaderForge.SFN_Final,id:0,x:32343,y:32843|diff-254-OUT,spec-330-OUT,gloss-146-OUT,normal-303-RGB,transm-191-OUT,amspl-191-OUT;n:type:ShaderForge.SFN_Tex2d,id:138,x:32898,y:32562,ptlb:MainTex,tex:b66bceaf0cc0ace4e9bdc92f14bba709,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:146,x:32850,y:32945|A-147-OUT,B-336-OUT;n:type:ShaderForge.SFN_Power,id:147,x:33022,y:32882|VAL-138-RGB,EXP-148-OUT;n:type:ShaderForge.SFN_Vector1,id:148,x:33207,y:32916,v1:2;n:type:ShaderForge.SFN_Vector1,id:163,x:33040,y:33527,v1:4;n:type:ShaderForge.SFN_Multiply,id:191,x:32683,y:33126|A-138-RGB,B-261-OUT;n:type:ShaderForge.SFN_Tex2d,id:249,x:32769,y:32358,ptlb:LightMap,ntxv:0,isnm:False|UVIN-269-UVOUT,MIP-269-U;n:type:ShaderForge.SFN_Multiply,id:250,x:32539,y:32240|A-252-OUT,B-249-RGB;n:type:ShaderForge.SFN_Slider,id:252,x:32890,y:32266,ptlb:LightmapBrightness,min:1,cur:3,max:5;n:type:ShaderForge.SFN_Multiply,id:253,x:32490,y:32495|A-250-OUT,B-138-RGB;n:type:ShaderForge.SFN_Multiply,id:254,x:32325,y:32151|A-255-RGB,B-253-OUT;n:type:ShaderForge.SFN_Color,id:255,x:32574,y:32067,ptlb:Color,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_ValueProperty,id:261,x:32906,y:33319,ptlb:SpcAmbientLit,v1:0.4;n:type:ShaderForge.SFN_TexCoord,id:269,x:33013,y:32371,uv:1;n:type:ShaderForge.SFN_Color,id:299,x:33149,y:33308,ptlb:TransmissionColor_copy,c1:0.625,c2:0.5489351,c3:0.3492647,c4:1;n:type:ShaderForge.SFN_Tex2d,id:303,x:32646,y:32938,ptlb:Normal,ntxv:3,isnm:True;n:type:ShaderForge.SFN_ValueProperty,id:330,x:33148,y:32728,ptlb:Specular,v1:0.3;n:type:ShaderForge.SFN_ValueProperty,id:336,x:33049,y:33154,ptlb:Gloss,v1:1;proporder:255-138-261-330-336-303-249-252;pass:END;sub:END;*/

Shader "Props/Dif_Nor_Spc(Leather)" {
    Properties {
        _Color ("Color", Color) = (0.5,0.5,0.5,1)
        _MainTex ("MainTex", 2D) = "white" {}
        _SpcAmbientLit ("SpcAmbientLit", Float ) = 0.4
...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(node_345.rg, _Normal))).rgb;
...
/////// Diffuse:
                ...
                float4 node_138 = tex2D(_MainTex,TRANSFORM_TEX(node_345.rg, _MainTex));
                float3 node_191 = (node_138.rgb*_SpcAmbientLit);
                float3 backLight = max(0.0, -NdotL ) * node_191;
                float3 diffuse = (forwardLight+backLight)*InvPi * attenColor + UNITY_LIGHTMODEL_AMBIENT.xyz*2;
///////// Gloss:
                float gloss = exp2((pow(node_138.rgb,2.0)*_Gloss)*10.0+1.0);
////// Specular:
                NdotL = max(0.0, NdotL);
                ...
                float3 specularAmb = node_191 * fresnelTermAmb;
...
/// Final Color:
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
/////// Normals:
                float2 node_346 = i.uv0;
                float3 normalLocal = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(node_346.rg, _Normal))).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
/////// Diffuse:
                ...
                float NdotL = dot( normalDirection, lightDirection );
                float3 forwardLight = max(0.0, NdotL );
                float4 node_138 = tex2D(_MainTex,TRANSFORM_TEX(node_346.rg, _MainTex));
                float3 node_191 = (node_138.rgb*_SpcAmbientLit);
                float3 backLight = max(0.0, -NdotL ) * node_191;
